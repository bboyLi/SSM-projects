    ...
    <div class="main-container-inner">
        ...
        <div class="sidebar" id="sidebar">
            ...
            <ul class="nav nav-list">
                <li class="open">
                    <a href="fuwu_dishes_list" >
                        <i class="icon-coffee"></i>
                        <span class="menu-text">菜品列表</span>
                    </a>
                    <a href="fuwu_dishes_tuijian" >
                        <i class="icon-coffee"></i>
                        <span class="menu-text">推荐菜品</span>
                    </a>
                    <a href="fuwu_orders_list" >
                        <i class="icon-coffee"></i>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
                                                                <a class="blue buy"  href="/fuwu_dishes_add?id=${item.id}" data-rel="tooltip" data-original-title="点菜" data-placement="top">
