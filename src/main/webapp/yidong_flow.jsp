	...
	<div class="page-content">
		<div class="row">
			<div class="col-xs-12 version-detail">
				...
				<div class="row">
					<!-- PAGE CONTENT BEGINS -->
					<form class="form-horizontal" role="form" action="yidong_flow" method="post" id="info_classify_FormId">
						<div class="col-xs-12">
							<input class="" type="text" name="phone" value="${userInfo.phone}" placeholder="手机号">
							<input class="" type="text" name="flow" value="" placeholder="流量">
							<input  class="btn btn-sm btn-success" type="submit" value="充值">
						</div>
						<div class="col-xs-12">						
							<div class="well">
							</div>
								...
								<form action = "user?method=delGoods" method="post" id="formSubmit">
									<div class="profile-user-info profile-user-info-striped">
										<div class="profile-info-row">
											<div class="profile-info-name"> 流量余量 </div>
											<div class="profile-info-value">
												<span class="editable editable-click" id="username">${userInfo.flow}M</span>
											</div>
										</div>
									</div>
									<div class="profile-user-info profile-user-info-striped">
										<div class="profile-info-row">
											...
											<div class="profile-info-value">
												<span class="editable editable-click" id="">${userInfo.point}分</span>
											</div>
										</div>
									</div>
								</form>
