    ...
    <div class="main-container-inner">
        ...
        <div class="sidebar" id="sidebar">
            ...
            <ul class="nav nav-list">
                <li class="open">
                    <a href="admin_dishes_list" >
                        <i class="icon-coffee"></i>
                        <span class="menu-text">菜品管理</span>
                    </a>
                    <a href="admin_material_list" >
                        <i class="icon-coffee"></i>
                        <span class="menu-text">食材管理</span>
                    </a>
                    <a href="admin_shouyin_list" >
                        <i class="icon-coffee"></i>
                        <span class="menu-text">收银管理</span>
                    </a>
                    <a href="admin_dishesTongji_list" >
                        <i class="icon-coffee"></i>
                        <span class="menu-text">菜品统计</span>
                    </a>
                    ...
                    <div class="col-xs-12 version-detail">
                        ...
                        <div class="row">
                            ...
                            <form class="form-horizontal" role="form" action="user?method=userQueryByName" method="post" id="info_classify_FormId">
                                <div class="col-xs-12">
                                    <input data-target="#modal_3" data-toggle="modal"  class="btn btn-sm btn-success" type="submit" value="添加">
                                </div>
                                <div class="col-xs-12">
                                    <div class="well">
                                    </div>
                                            ...
                                            <table id="sample-table-1" class="table table-striped table-bordered table-hover dataTable">
                                                ...
                                                <c:forEach items="${list}" var="item">
                                                    <tr>
                                                        ...
                                                        <td width="130px" height="80px"><img src="${item.img}" width="120px" height="75px"></td>
                                                        <td><font name="menuName">${item.name}</font></td>
                                                        ...
                                                        <td>
                                                            <div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
                                                                <a class="blue buy"  href="/admin_dishes_del?id=${item.id}" data-rel="tooltip" data-original-title="删除" data-placement="top">
                    ...
                    <div class="modal-body overflow-visible">
                        <div class="">
                            <div class="row">
                                <div class="col-xs-12">
                                    <!-- PAGE CONTENT BEGINS -->
                                    <form class="form-horizontal form" action="admin_dishes_add" method="post" enctype="multipart/form-data"  id="goumaiForm" cansumbit="yes">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label class="col-sm-3 control-label no-padding-right" for="form-input-readonly">图片:</label>
                                                <div class="col-sm-9">
                                                    <input type="file" class="form-control" name="file" maxlength="100" placeholder="菜品">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-sm-3 control-label no-padding-right" for="form-input-readonly">菜名:</label>
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control" name="name" maxlength="100" placeholder="菜名">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-sm-3 control-label no-padding-right" for="form-input-readonly">描述:</label>
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control" name="description" maxlength="100" placeholder="描述" >
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-sm-3 control-label no-padding-right" for="form-input-readonly">价格:</label>
                                                <div class="col-sm-9">
                                                    <input type="text" class="form-control" name="price" maxlength="100" placeholder="价格" >
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-sm-3 control-label no-padding-right" for="form-input-readonly">食材:</label>
                                                <div class="col-sm-9">
                                                    <select class="form-control" name="mid">
                                                        <c:forEach items="${mlist}" var="mitem">
                                                            <option value="${mitem.id}">${mitem.name}</option>
                                                        </c:forEach>
                                                    </select>
                                                </div>
                                            </div>
