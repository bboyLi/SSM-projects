...
<div class="main-container" id="main-container">
    ...
    <div class="main-container-inner">
                    ...
                    <div class="col-xs-12 version-detail">
                        ...
                        <div class="row">
                            ...
                            <form class="form-horizontal" role="form" action="user?method=userQueryByName" method="post" id="info_classify_FormId">
                                <div class="col-xs-12">
                                    <input data-target="#modal_3" data-toggle="modal"  class="btn btn-sm btn-success" type="submit" value="进货">
                                </div>
                                <div class="col-xs-12">
                                    <div class="well">
                                    </div>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
                                                                <a class="blue buy" data-target="#modal_4" data-toggle="modal" mid="${item.id}"  href="#" data-rel="tooltip" data-original-title="退货" data-placement="top">
                ...
                <div class="modal-body overflow-visible">
                    <div class="">
                        <div class="row">
                            <div class="col-xs-12">
                                <!-- PAGE CONTENT BEGINS -->
                                <form class="form-horizontal form" action="admin_material_add" method="post" id="goumaiForm" cansumbit="yes">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label no-padding-right" for="form-input-readonly">食材名:</label>
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" name="name" maxlength="100" placeholder="食材名">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-sm-3 control-label no-padding-right" for="form-input-readonly">数量:</label>
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" name="num" maxlength="100" placeholder="数量" >
                                            </div>
                                        </div>
                                        <div class="form-group">
        ...
        <div id="modal_4" class="modal" tabindex="-1">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                        <h4 class="blue bigger">退货</h4>
                    </div>
                    <div class="modal-body overflow-visible">
                        <div class="">
                            <div class="row">
                                <div class="col-xs-12">
                                    <!-- PAGE CONTENT BEGINS -->
                                    <form class="form-horizontal form" action="admin_material_sub"  method="post" id="goumaiForm1" cansumbit="yes">
                    ...
                    <div class="modal-footer">
                        <button id="queding" class="btn btn-sm btn-success" data-dismiss="modal">
                            <i class="icon-plus"></i>确定
                        </button>
                        <button class="btn btn-sm btn-danger" data-dismiss="modal">
                            <i class="icon-remove"></i>取消
