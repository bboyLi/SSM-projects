	...
	<div class="page-content">
		<div class="row">
			<div class="col-xs-12 version-detail">
				...
				<div class="row">
					<!-- PAGE CONTENT BEGINS -->
					<form class="form-horizontal" role="form" action="yidong_fare" method="post" id="info_classify_FormId">
						<div class="col-xs-12">
							<input class="" type="text" name="phone" value="${userInfo.phone}" placeholder="手机号">
							<input class="" type="text" name="fare" value="" placeholder="金额">
								...
								<form action = "user?method=delGoods" method="post" id="formSubmit">
									<div class="profile-user-info profile-user-info-striped">
										<div class="profile-info-row">
											<div class="profile-info-name"> 话费余额 </div>
											<div class="profile-info-value">
												<span class="editable editable-click" id="username">${userInfo.fare}元</span>
											</div>
										</div>
									</div>
									<div class="profile-user-info profile-user-info-striped">
