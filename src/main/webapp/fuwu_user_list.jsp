		...
		<div class="main-container-inner">
			...
			<div class="sidebar" id="sidebar">
				...
				<ul class="nav nav-list">
					<li class="open">
						<a href="fuwu_user_list" >
							<i class="icon-coffee"></i>
							<span class="menu-text">移动用户管理</span>
						</a>
						<a href="fuwu_business_list" >
							<i class="icon-coffee"></i>
							<span class="menu-text">用户业务数据模块</span>
						</a>
										...
										<tr>
											...
											<td>
												<div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
													<a class="blue buy"  href="/delFuwuUser?id=${item.id}&userId=${item.userid}" data-rel="tooltip" data-original-title="删除" data-placement="top">
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="blue bigger">添加移动用户</h4>
			</div>
			<div class="modal-body overflow-visible">
				<div class="">
					<div class="row">
						<div class="col-xs-12">
							<!-- PAGE CONTENT BEGINS -->
							<form class="form-horizontal form" action="addFuwuUser" method="post" id="goumaiForm" cansumbit="yes">
								<div class="col-md-12">
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-input-readonly">用户名:</label>
										<div class="col-sm-9">
											<input type="text" class="form-control" name="username" maxlength="100" placeholder="用户名">
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-input-readonly">姓名:</label>
										<div class="col-sm-9">
											<input type="text" class="form-control" name="name" maxlength="100" placeholder="姓名" >
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-input-readonly">手机号:</label>
										<div class="col-sm-9">
											<input type="text" class="form-control" name="phone" maxlength="100" placeholder="手机号">
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-input-readonly">积分:</label>
										<div class="col-sm-9">
											<input type="text" class="form-control" name="point" maxlength="100" placeholder="积分">
										</div>
									</div>
									<div class="form-group">
										<label class="col-sm-3 control-label no-padding-right" for="form-input-readonly">话费:</label>
										<div class="col-sm-9">
											<input type="text" class="form-control" name="fare" maxlength="100" placeholder="话费">
										</div>
									</div>
								</div>
							</form>
