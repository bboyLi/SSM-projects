									...
									<div class="profile-user-info profile-user-info-striped">
										<div class="profile-info-row">
											...
											<div class="profile-info-value">
												<span class="editable editable-click" id="">${userInfo.phone}</span>
											</div>
										</div>
									</div>
									<div class="profile-user-info profile-user-info-striped">
										<div class="profile-info-row">
											...
											<div class="profile-info-value">
												<span class="editable editable-click" id="signup">${userInfo.point}分</span>
											</div>
										</div>
									</div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="visible-md visible-lg hidden-sm hidden-xs action-buttons">
                                                        <a class="blue buy"  href="yidong_buyGift?id=${item.id}" data-rel="tooltip" data-original-title="兑换" data-placement="top">
